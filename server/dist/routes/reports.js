...
router.get('/', auth_1.extractTenantScope, async (req, res) => {
    try {
        ...
        const overallStats = await (0, db_1.queryOne)(`
      SELECT
        COUNT(*) as total,
    ...
    `, [restaurantId, startIso, endIso]);
        ...
        // 2. Daily breakdown
        const dailyRows = await (0, db_1.queryAll)(`
      SELECT
    ...
    `, [restaurantId, startIso, endIso]);
        ...
        const failedAttempts = await (0, db_1.queryAll)(`
    ...
    `, [restaurantId, startIso, endIso]);
        ...
        for (const attempt of failedAttempts) {
            try {
                const missingList = JSON.parse(attempt.missing_required || '[]');
        ...
        const deptRows = await (0, db_1.queryAll)(`
      SELECT
        w.department,
        COUNT(*) as total,
