 ...
 */
router.post('/detect', auth_1.extractTenantScope, async (req, res) => {
    ...
    try {
        ...
        const settings = await (0, db_1.queryOne)('SELECT real_model_endpoint, real_model_api_key FROM restaurant_settings WHERE restaurant_id = ?', [restaurantId]);
